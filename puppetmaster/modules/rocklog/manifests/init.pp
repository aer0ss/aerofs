class rocklog {
    ...
    exec{"get elasticsearch deb":
        command => "/usr/bin/wget https://download.elasticsearch.org/elasticsearch/elasticsearch/elasticsearch-1.0.0.deb",
        cwd => "/root/",
        creates => "/root/elasticsearch-1.0.0.deb",
    ...
    package{ "elasticsearch" :
        ...
        source => "/root/elasticsearch-1.0.0.deb",
