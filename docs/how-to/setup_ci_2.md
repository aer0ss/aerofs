See also [setup_ci_1](setup_ci_1.html), [setup_syncdet_actors](setup_syncdet_actors.html), [setup_syncdet_vagrant](setup_syncdet_vagrant.html), [setup_syncdet](setup_syncdet.html). **TODO: consolidate them.**
