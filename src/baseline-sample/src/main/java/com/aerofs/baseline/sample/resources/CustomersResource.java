...
import com.aerofs.baseline.sample.SampleConfiguration;
...
public final class CustomersResource {
    ...
    private static final Timer CUSTOMER_CREATION_TIMER = MetricRegistries.getRegistry().timer(MetricRegistries.name("sample", "customer", "new"));

    private final DBI dbi;
    private final SampleConfiguration configuration;
    private final ResourceContext resourceContext;

    public CustomersResource(@Context DBI dbi, @Context SampleConfiguration configuration, @Context ResourceContext resourceContext) {
        this.dbi = dbi;
