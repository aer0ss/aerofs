 ...
 * {@link AeroUserDevicePrincipal} instances into {@link javax.ws.rs.core.Context}-
 ...
 */
@Provider
public final class AeroUserDevicePrincipalBinder extends AbstractBinder {

    private static final class ActualPrincipalFactory extends PrincipalFactory<AeroUserDevicePrincipal> {
    ...
    protected void configure() {
        bindFactory(ActualPrincipalFactory.class).to(AeroUserDevicePrincipal.class);
    }
}
