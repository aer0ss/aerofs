 ...
 * methods from <code>ISignallingServiceListener</code> into the definition of
 * <code>ISignalledUnicastConnectionService</code>. However, the current approach preserves the
 * relationship between <code>ISignallingService</code> and <code>ISignallingServiceListener</code>. It also
 * allows <code>ISignallingService</code> instances to callback instances of
 * <code>ISignallingServiceListener</code> that are <em>not</em> also <code>IUnicastConnectionService</code>
