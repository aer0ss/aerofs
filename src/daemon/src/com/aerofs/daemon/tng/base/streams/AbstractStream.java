...
abstract class AbstractStream implements IStream
{
    ...
    protected AbstractStream(ISingleThreadedPrioritizedExecutor executor, StreamID id, DID did, Prio pri)
    {
        this._executor = executor;
        this._id = id;
        this._did = did;
        this._pri = pri;
        this._hash = hash(id, did, pri);
    }

    private static int hash(StreamID id, DID did, Prio pri) // FIXME: broken
    {
    ...
    public final boolean equals(Object o)
    {
        ...
        return stream.getStreamId_().equals(getStreamId_()) && stream.getDid_().equals(getDid_()) &&
                stream.getPriority_().equals(getPriority_());
    }
    ...
    {
        return "id:" + getStreamId_() + " d:" + getDid_() + " pri:" +
                getPriority_();
    }
