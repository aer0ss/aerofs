...
/**
 * Implemented by classes that want to track basic networking statistics, including (but not limited
 * to), bytes transmitted and received, etc.
 */
public interface INetworkStats
{
    ...
    /**
     * Convenience class that implements {@link INetworkStats}. It does no error checking (i.e.
     * <code>bytesrx</code> and <code>bytestx</code> can be negative) and is not thread-safe. It can
     * however, be used in a multi-threaded context if precision is unnecessary.
     */
