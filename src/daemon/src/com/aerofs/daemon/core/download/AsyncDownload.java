 ...
 * if needed. See:
 * {@link com.aerofs.daemon.core.download.dependence.DownloadDependenciesGraph}
 * {@link com.aerofs.daemon.core.download.dependence.DownloadDeadlockResolver}
 *
...
class AsyncDownload extends Download
{
    ...
    public static class Factory extends Download.Factory
    {
        ...
        public Factory(DirectoryService ds, DownloadState dlstate, Downloads dls,
                ...
                NativeVersionControl nvc, DownloadDeadlockResolver ddr)
        {
            super(ds, dlstate, dls, factTo, gcc, gcr, ddr);
            _nvc = nvc;
        }
