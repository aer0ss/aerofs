...
public class SeedCreator
{
    ...
    public String create_() throws Exception
    {
        ...
        try {
            ...
            _ds.walk_(soid, new Path(), new ObjectWalkerAdapter<Path>() {
                @Override
                @Nullable public Path prefixWalk_(Path parentPath, OA oa) throws SQLException
                {
            ...
            l.info("failed to create seed", e);
            sdb.cleanup_();
            throw e;
        }
    }
