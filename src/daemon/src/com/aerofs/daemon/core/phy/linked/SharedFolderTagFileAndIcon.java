...
public class SharedFolderTagFileAndIcon
{
    ...
    public void addTagFileAndIconIn(SID sid, String absPath) throws IOException
    {
        ...
        String absPathTagFile = Util.join(absPath, ClientParam.SHARED_FOLDER_TAG);
    ...
    public void deleteTagFileAndIconIn(String absPath) throws IOException
    {
        ...
        deleteTagFile(Util.join(absPath, ClientParam.SHARED_FOLDER_TAG));
    }
    ...
    public boolean isUsableSharedFolderRoot(SID sid, InjectableFile d) {
        InjectableFile tag = d.newChild(ClientParam.SHARED_FOLDER_TAG);
