...
public class DTLSLayer implements IDuplexLayer, IDumpStatMisc
{
    ...
    {
        private final DTLSMessage.Factory<InputStream> _factMsgIS;
            ...
            throws IOException
    {
        ...
        String pathCACert = Util.join(AppRoot.abs(), LibParam.CA_CERT);
        ...
        String pathDevCert = Util.join(Cfg.absRTRoot(), LibParam.DEVICE_CERT);
            ...
            case OUT_OLD: {
                ...
                if (entries.isEmpty()) {
                    ...
                    for (DTLSEntry entry : entries) {
                        ...
                        InputStream isToDeliver = entry.decrypt_(input, pc,
