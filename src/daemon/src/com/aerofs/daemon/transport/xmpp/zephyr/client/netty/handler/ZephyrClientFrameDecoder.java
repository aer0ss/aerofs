...
public class ZephyrClientFrameDecoder extends FrameDecoder {
            ...
            ChannelBuffer buffer) throws Exception
    {
        ...
        return _clientMessage ? new ZephyrClientMessage(payload) :
                new ZephyrServerMessage(payload);
    }
