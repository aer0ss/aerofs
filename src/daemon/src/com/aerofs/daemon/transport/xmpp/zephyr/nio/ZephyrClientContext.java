...
import com.aerofs.daemon.transport.xmpp.zephyr.nio.statemachine.IStateContext;
...
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ClientConstants.ZEPHYR_CLIENT_HDR_LEN;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientContext.HandshakeMessageType.ACK;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientContext.HandshakeMessageType.SYN;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientContext.HandshakeMessageType.SYNACK;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.BEGIN_CONNECT;
...
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientState.TERMINATED;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientUtil.handleError;
