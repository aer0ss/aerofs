...
import com.aerofs.daemon.transport.xmpp.zephyr.nio.statemachine.IState;
import com.aerofs.daemon.transport.xmpp.zephyr.nio.statemachine.IStateEventType;
import com.aerofs.daemon.transport.xmpp.zephyr.nio.statemachine.StateMachineSpec;
import com.aerofs.daemon.transport.xmpp.zephyr.nio.statemachine.StateMachineSpec.StateMachineSpecBuilder;
import com.google.common.collect.ImmutableMap;
import com.google.common.collect.ImmutableSet;

import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.BOUND;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.CONNECTED;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.HANDSHAKE_COMPLETE;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.PENDING_OUT_PACKET;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.PREPARED_FOR_BINDING;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.PREPARED_FOR_CONNECT;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.PREPARED_FOR_REGISTRATION;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.RECVD_ACK;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.RECVD_SYN;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.RECVD_SYNACK;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.REGISTERED;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.SEL_CONNECT;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.SEL_READ;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.SEL_WRITE;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.SENT_SYN;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.SENT_SYNACK;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientEventType.WRITE_COMPLETE;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientState.BINDING;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientState.CONNECTING;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientState.HANDSHAKE;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientState.PREP_FOR_BINDING;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientState.PREP_FOR_CONNECT;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientState.PREP_FOR_REGISTRATION;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientState.RECVING;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientState.REGISTERING;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientState.SENDING_AND_RECVING;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientState.WAIT_FOR_HANDSHAKE_ACK;
import static com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientState.WAIT_FOR_HANDSHAKE_SYNACK;
