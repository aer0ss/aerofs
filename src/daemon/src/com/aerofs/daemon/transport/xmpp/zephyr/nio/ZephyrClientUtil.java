...
/**
 * Utility functions for {@link ZephyrClientState} and {@link com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientContext}
 * objects.
 *
...
class ZephyrClientUtil
{
     ...
     * (usually {@link com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientContext}.toString())
     * @param l            {@link Logger} to use to print messages
     */
     ...
     *
     * @param boss   {@link com.aerofs.daemon.transport.xmpp.zephyr.nio.ZephyrClientManager} that owns the BufferPool
