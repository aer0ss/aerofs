...
import static com.aerofs.daemon.transport.xmpp.XMPPUtilities.allLinksDown;

public class JingleWrapper implements ISignalledConnectionService, IJingle
{
    public JingleWrapper(DID localdid, String xmppPassword, String absRTRoot, String id, int rank, IConnectionServiceListener connectionServiceListener, TransportStats transportStats)
    {
    ...
    {
        if (!(o instanceof JingleWrapper)) return false;

        JingleWrapper j = (JingleWrapper)o;
    ...
    public void connect(final DID did)
    {
        ...
        signalThread.call(new ISignalThreadTask()
        {
            ...
            public void error(Exception e)
            {
                ...
                connectionServiceListener.onDeviceDisconnected(did, JingleWrapper.this);
            }
...
//    }
    ...
    private static final Logger l = Loggers.getLogger(JingleWrapper.class);
