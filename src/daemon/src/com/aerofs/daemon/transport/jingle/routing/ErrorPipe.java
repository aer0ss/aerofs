...
/**
 * An implementation of {@link com.aerofs.daemon.transport.jingle.IConnectionService} that simply notifes the sender that there
 * was an error in sending a packet
 */
class ErrorPipe implements IConnectionService
{
