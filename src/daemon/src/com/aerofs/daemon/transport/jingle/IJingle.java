...
public interface IJingle
{
    ...
    /**
     * @see com.aerofs.daemon.transport.lib.IConnectionServiceListener#onDeviceConnected(DID, com.aerofs.daemon.transport.jingle.routing.IConnectionService)
     * Simple pass-through from internal <code>jingle</code> components to an
    ...
    /**
     * @see com.aerofs.daemon.transport.lib.IConnectionServiceListener#onDeviceDisconnected(DID, com.aerofs.daemon.transport.jingle.routing.IConnectionService)
     * Simple pass-through from internal <code>jingle</code> components to an
     * <code>IJingle</code> implementation that will route the call to an
     * instance of <code>IConnectionServiceListener</code>
     */
