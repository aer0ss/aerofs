...
import static com.aerofs.daemon.transport.jingle.routing.NoopWaiter.NOOP_WAITER;
import static java.util.Collections.unmodifiableSortedMap;

/**
 * Represents the state of a single logical connected pipe - which may
 * contain multiple underlying {@link com.aerofs.daemon.transport.jingle.IConnectionService} objects - to a device represented
 ...
 *          the affected {@link com.aerofs.daemon.transport.jingle.IConnectionService}.</li>
 * </ol>
 */
...
class DIDPipeRouter<T extends IConnectionService>
{
     ...
     * @param connectionService {@link com.aerofs.daemon.transport.jingle.IConnectionService} object that can be used to connect to devices
     */
    ...
    /**
     * @return the preference of the best connected {@link com.aerofs.daemon.transport.jingle.IConnectionService}
     */
    ...
    /**
     * @return the best connected {@link com.aerofs.daemon.transport.jingle.IConnectionService}
     */
    ...
    /**
     * @return the preference of the best <em>available (i.e. configured)</em> {@link com.aerofs.daemon.transport.jingle.IConnectionService}
     */
    ...
    /**
     * Asserts that the {@link com.aerofs.daemon.transport.jingle.IConnectionService} passed in as a parameter is not an instance
     * of <code>ERROR_PIPE</code>
     *
     * @param p {@link com.aerofs.daemon.transport.jingle.IConnectionService} to check
     */
     ...
     * {@link com.aerofs.daemon.transport.jingle.IConnectionService} preferences. In this map, the entry with the lowest number
