...
public final class ClientHandler extends SimpleChannelHandler implements CNameListener
{
    ...
    // The listener who will be notified when this channel is connected
    ...
    public ClientHandler(IUnicastListener unicastListener)
    {
    ...
    /**
     * @return the {@code Channel} to which this {@code ClientHandler} is bound.
     * May be {@code null} if the pipeline failed to be initialized.
     */
