...
public class TransportDiagnosisState {
    ...
    LRUCache<Integer, Long> _pingCache =
        new LRUCache<Integer, Long>(DaemonParam.TRANSPORT_DIAGNOSIS_CACHE_CAPACITY);
    ...
    // receiving the flood
    LRUCache<Integer, FloodEntry> _floodCache =
        new LRUCache<Integer, FloodEntry>(DaemonParam.TRANSPORT_DIAGNOSIS_CACHE_CAPACITY * 4);
