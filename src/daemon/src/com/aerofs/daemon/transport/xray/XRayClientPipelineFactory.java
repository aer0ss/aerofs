...
final class XRayClientPipelineFactory implements ChannelPipelineFactory
{
    ...
    private static final String XRAY_CLIENT_HANDLER_NAME = "xray-client";
    ...
    public ChannelPipeline getPipeline() throws Exception
    {
        ...
        // zephyr client
        XRayClientHandler zephyrClientHandler = newZephyrClientHandler(ioStatsHandler, zephyrProtocolHandler);
    ...
    {
        return new ZephyrProtocolHandler(xraySignallingService, timer, xrayHandshakeTimeout, xrayHandshakeTimeoutTimeunit);
    }
    ...
    {
        return new XRayClientHandler(unicastListener, ioStatsHandler, zephyrProtocolHandler);
    }
     ...
     * @param channel Channel from which to get the handler instance
     */
    static XRayClientHandler getZephyrClient(Channel channel)
    {
        return (XRayClientHandler) channel.getPipeline().get(XRAY_CLIENT_HANDLER_NAME);
    }
}
