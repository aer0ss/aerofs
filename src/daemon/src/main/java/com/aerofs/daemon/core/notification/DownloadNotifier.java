...
class DownloadNotifier extends AbstractTransferNotifier
{
    ...
    {
        @Inject
        public DownloadThrottler(ElapsedTimer.Factory factTimer)
        {
            super(factTimer);
        }
    }
    ...
    @Inject
    DownloadNotifier(DirectoryService ds, UserAndDeviceNames nr, RitualNotificationServer rns,
                     CoreScheduler sched, DownloadThrottler throttler)
    {
