...
public final class TestXRayUnicast
{
    ...
    private static final Logger l = LoggerFactory.getLogger(TestXRayUnicast.class);

    private static final byte[] TEST_DATA = "hello".getBytes(Charsets.US_ASCII);

    private XRayServer xray;
    private UnicastXRayDevice localDevice;
    private UnicastXRayDevice otherDevice;
            ...
            throws Exception
    {
        ...
        xrayThread.setName("xray-runner");
        xrayThread.start();
    ...
    private Channel sendPacketAndWaitForItToBeReceived(UnicastXRayDevice senderDevice, UnicastXRayDevice receiverDevice, byte[] data)
