...
final class SPSchema
{
    ...
    static final String T_ER                           = "sp_email_reminders";
    static final String C_ER_EMAIL                     = "er_email";
    static final String C_ER_CATEGORY                  = "er_category";
    static final String C_ER_FIRST_EMAIL               = "er_first_email_sent";
    static final String C_ER_LAST_EMAIL                = "er_last_email_sent";
}
