...
<div class="page-block">
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <a class="btn btn-default" href="#" onclick="inputCreditCardInfo(updateCreditCard); return false;">
                Update
            </a>
        </div>
    </div>
...
<div class="page-block">
    <a class="btn btn-default" href="#" onclick="cancelSubscription(); return false;">
        Cancel Subscription
    </a>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="#" class="btn btn-default" data-dismiss="modal">Go Back</a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form style="margin-left: 80px; margin-top: 16.5pt;">
                    <textarea id="feedback" rows="3" class="col-sm-4"></textarea>
                </form>
