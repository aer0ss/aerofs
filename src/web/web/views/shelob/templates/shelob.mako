...
<%block name="scripts">
    ...
    <script src="${request.static_path('web:static/shelob/lib/datepicker/bootstrap-datepicker.js')}"></script>
...
<%block name="css">
    ...
    <link rel="stylesheet" href="${request.static_path('web:static/shelob/lib/datepicker/datepicker.css')}"/>
    <link rel="stylesheet" href="${request.static_path('web:static/shelob/lib/datepicker/datepicker3.css')}"/>
</%block>
