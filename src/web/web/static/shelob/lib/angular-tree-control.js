// N.B. (JG) this file has been modified from the original, which is found at
            ...
            return {
                ...
                controller: function( $scope ) {
                    ...
                    $scope.selectNodeHead = function() {
                        ...
                        if ($scope.onExpand) $scope.onExpand({node: this.node});
                    };
                    ...
                    var template =
                        '<ul '+classIfDefined($scope.options.injectClasses.ul, true)+'>' +
                            ...
                            '<i class="tree-leaf-head '+classIfDefined($scope.options.injectClasses.iLeaf, false)+'" ng-click="selectNodeHead(node)"></i>' +
