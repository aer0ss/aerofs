...
public class PlanCreated extends StripeEvent<Plan> {

    @JsonCreator
    private PlanCreated( @JsonProperty( ID_KEY ) final String id,
    ...
    public static final String STRIPE_ID = "plan.created";
