...
public class InvoicePaymentSucceeded extends StripeEvent<Invoice> {

    @JsonCreator
    private InvoicePaymentSucceeded( @JsonProperty( ID_KEY ) final String id,
            ...
            @JsonProperty( DATA_KEY ) final EventData<Invoice> data ) {
    ...
    public static final String STRIPE_ID = "invoice.payment_succeeded";
