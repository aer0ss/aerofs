...
public class InvoiceItemUpdated extends StripeEvent<InvoiceItem> {

    @JsonCreator
    private InvoiceItemUpdated( @JsonProperty( ID_KEY ) final String id,
    ...
    public static final String STRIPE_ID = "invoiceitem.updated";
