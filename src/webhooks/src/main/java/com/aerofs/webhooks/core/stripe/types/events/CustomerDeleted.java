...
public class CustomerDeleted extends StripeEvent<Customer> {

    @JsonCreator
    private CustomerDeleted( @JsonProperty( ID_KEY ) final String id,
    ...
    public static final String STRIPE_ID = "customer.deleted";
