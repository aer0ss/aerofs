...
public class CouponDeleted extends StripeEvent<Coupon> {

    @JsonCreator
    private CouponDeleted( @JsonProperty( ID_KEY ) final String id,
    ...
    public static final String STRIPE_ID = "coupon.deleted";
