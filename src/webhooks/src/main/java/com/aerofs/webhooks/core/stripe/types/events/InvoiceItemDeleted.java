...
public class InvoiceItemDeleted extends StripeEvent<InvoiceItem> {

    @JsonCreator
    private InvoiceItemDeleted( @JsonProperty( ID_KEY ) final String id,
    ...
    public static final String STRIPE_ID = "invoiceitem.deleted";
