...
public class ChargeRefunded extends ChargeEvent {

    @JsonCreator
    private ChargeRefunded( @JsonProperty( ID_KEY ) final String id,
    ...
    public static final String STRIPE_ID = "charge.refunded";
