...
public class InvoicePaymentFailed extends StripeEvent<Invoice> {

    @JsonCreator
    private InvoicePaymentFailed( @JsonProperty( ID_KEY ) final String id,
    ...
    public static final String STRIPE_ID = "invoice.payment_failed";
