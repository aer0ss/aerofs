...
public class InvoiceUpdated extends StripeEvent<Invoice> {

    @JsonCreator
    private InvoiceUpdated( @JsonProperty( ID_KEY ) final String id,
    ...
    public static final String STRIPE_ID = "invoice.updated";
