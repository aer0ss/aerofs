...
public class PlanDeleted extends StripeEvent<Plan> {

    @JsonCreator
    private PlanDeleted( @JsonProperty( ID_KEY ) final String id,
    ...
    public static final String STRIPE_ID = "plan.deleted";
