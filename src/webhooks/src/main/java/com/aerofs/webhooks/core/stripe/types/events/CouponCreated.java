...
public class CouponCreated extends StripeEvent<Coupon> {

    @JsonCreator
    private CouponCreated( @JsonProperty( ID_KEY ) final String id,
            ...
            @JsonProperty( DATA_KEY ) final EventData<Coupon> data ) {
    ...
    public static final String STRIPE_ID = "coupon.created";
