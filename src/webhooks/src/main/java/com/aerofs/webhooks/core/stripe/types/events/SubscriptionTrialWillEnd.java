...
public class SubscriptionTrialWillEnd extends SubscriptionEvent {

    @JsonCreator
    private SubscriptionTrialWillEnd( @JsonProperty( ID_KEY ) final String id,
    ...
    public static final String STRIPE_ID = "customer.subscription.trial_will_end";
