...
public class ChargeFailed extends ChargeEvent {

    @JsonCreator
    private ChargeFailed( @JsonProperty( ID_KEY ) final String id,
    ...
    public static final String STRIPE_ID = "charge.failed";
