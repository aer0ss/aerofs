...
public class SubscriptionDeleted extends SubscriptionEvent {

    @JsonCreator
    private SubscriptionDeleted( @JsonProperty( ID_KEY ) final String id,
    ...
    public static final String STRIPE_ID = "customer.subscription.deleted";
