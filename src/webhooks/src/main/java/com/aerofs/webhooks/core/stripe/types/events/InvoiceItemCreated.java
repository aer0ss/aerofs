...
public class InvoiceItemCreated extends StripeEvent<InvoiceItem> {

    @JsonCreator
    private InvoiceItemCreated( @JsonProperty( ID_KEY ) final String id,
            ...
            @JsonProperty( DATA_KEY ) final EventData<InvoiceItem> data ) {
    ...
    public static final String STRIPE_ID = "invoiceitem.created";
