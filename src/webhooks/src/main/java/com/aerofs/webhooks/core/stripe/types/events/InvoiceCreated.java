...
public class InvoiceCreated extends StripeEvent<Invoice> {

    @JsonCreator
    private InvoiceCreated( @JsonProperty( ID_KEY ) final String id,
    ...
    public static final String STRIPE_ID = "invoice.created";
