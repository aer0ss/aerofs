...
public class Images {
    ...
    public static final String ICON_USER_ADD = "userAdd.png";
    public static final String ICON_USER_DELETE = "userDelete.png";
    public static final String ICON_PEN = "pen.png";
    public static final String ICON_GROUP = "group.png";
    public static final String ICON_PLUS_SMALL = "plusSmall.png";
    public static final String ICON_MINUS_SMALL = "minusSmall.png";
    public static final String ICON_PLUS_OFFSET = "plusOffset.png";
    public static final String ICON_MINUS_OFFSET = "minusOffset.png";
    ...
    public static final String ICON_ARROW_LEFT = "arrowLeft.png";
    public static final String ICON_ARROW_RIGHT = "arrowRight.png";
    ...
    public static final String ICON_LED_GREEN = "ledGreen.png";
    public static final String ICON_LED_GREY = "ledGrey.png";
    public static final String ICON_PIN_BLUE = "pinBlue.png";
    public static final String ICON_PIN_GREY = "pinGrey.png";
    public static final String ICON_PIN_HOLE = "pinHole.png";
