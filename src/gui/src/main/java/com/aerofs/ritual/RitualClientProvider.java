...
public final class RitualClientProvider implements IRitualClientProvider
{
    ...
    private final ChannelPipelineFactory _pipelineFactory = () -> (Channels.pipeline(
            new LengthFieldBasedFrameDecoder(ClientParam.Ritual.MAX_FRAME_LENGTH, 0, ClientParam.Ritual.LENGTH_FIELD_SIZE, 0, ClientParam.Ritual.LENGTH_FIELD_SIZE),
            new LengthFieldPrepender(ClientParam.Ritual.LENGTH_FIELD_SIZE),
