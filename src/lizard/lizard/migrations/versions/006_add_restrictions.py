...
license = Table('license', post_meta,
    ...
    Column('allow_audit', Boolean, nullable=False, server_default=text('false'), default=ColumnDefault(False)),
    Column('allow_identity', Boolean, nullable=False, server_default=text('false')),
    Column('allow_mdm', Boolean, nullable=False, server_default=text('false')),
    Column('allow_device_restriction', Boolean, nullable=False, server_default=text('false')),
