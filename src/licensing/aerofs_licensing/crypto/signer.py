...
def sign_with_aerofs_licensing_privkey(input_flo, output_flo):
    # Use the keys available in the specified homedir
    ctx = gpgme.Context()
    ctx.set_engine_info(gpgme.PROTOCOL_OpenPGP, find_gpg_executable(), gpg_secret_homedir)
    ...
    ctx.passphrase_cb = _passphrase_cb
