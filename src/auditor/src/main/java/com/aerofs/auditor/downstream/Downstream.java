...
public class Downstream
{
     ...
     */
    public static AuditChannel create()
    {
     ...
     * we need one...
     */
    static class NewLineDelimitedStream implements AuditChannel, AuditChannelConnectNotifier
    {
     ...
     */
    static private class DummyStream implements AuditChannel
    {
        @Override
        public ChannelFuture doSend(String message)
        {
