...
public class TestDownstream extends AbstractTest
{
    ...
    public void streamShouldFrameMessages() throws Exception
    {
        ...
        AuditChannel auditChannel = Downstream.create();

        waitForConnectState(auditChannel, true);

        auditChannel.doSend(testValue);
    ...
    {
        AuditChannel chan = Downstream.create();
    ...
    private void waitForConnectState(AuditChannel channel, boolean expected)
    {
        int attempts=0;
