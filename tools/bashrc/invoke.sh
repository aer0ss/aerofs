...
_invoke()
{
    ...
    commands="build_client build_protoc_plugins build_docker_images build_vm build_cloud_config push_docker_images push_vm tag_release clean markdown markdown_watch package_clients prepare_syncdet proto setupenv test_js test_python test_system test_system_archive write_version"
